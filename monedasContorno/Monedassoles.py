...
#al no trabajar bien hay que cambiar los valores gauss y kernel
original = cv2.imread("C:\Agus\Python\Monedas contorno\monedassoles.jpg")
gris = cv2.cvtColor(original, cv2.COLOR_BGR2GRAY)
#Estos valores impares
valorgauss=1
valorkernel=33
#con monedass gaus 15 kernel 3
